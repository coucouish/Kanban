<template>
  <div class="echart_7">
    <div class="tit">学院教师基础信息</div>
    <div class="boxnav" id="echart7"></div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.chart = echarts.init(document.getElementById("echart7"));
    axios
      .get(`${this.Global.API_URL}data7`)
      .then((response) => {
